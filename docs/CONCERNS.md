...
`docs/DEVELOPMENT.md` notes that standalone GitHub release signing depends on repository secrets in `enclaro/kanarek`. Secret values cannot be verified from repository contents.
